...
export class NeuralNetworkList {
    ...
    draw(ctx, left, top, width, height, rowSize, displayHeaderHeight, displayHeader, displayErrorDigits, displayMeanError, scrollY = 0) {
    ...
    drawXGBoostEnsemble(ctx, left, top, width, height, displayHeaderHeight) {
        ctx.save();
        // Draw header
        ctx.fillStyle = "#e0e0e0";
